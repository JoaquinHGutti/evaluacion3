          ...
          <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
              ...
              <div class="navbar-bottom">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <a class="navbar-brand" href="#"></a> LircayHub
                  </div>
                  <div>
                    <button
                  ...
                  <div class="aboutus-wrapper">
                    ...
                    <div class="row">
                      <div class="col-lg-12 mb-5 mb-sm-2">
                        <h2> Temas :</h2>
                             <span> 1 : Elecciones Chile 2021 </span> <br>
                             <span> 2 : Clasificatorias Qatar </span> <br>
                             <span> 3 : Cambio climatico </span> <br>
                             <span> 4 : Energia renovable </span> <br>
                             <span> 5 : Ciencia de datos </span> <br>
                             <span> 6 : Universo cinematografico </span> <br>
