              ...
              <div class="card" data-aos="fade-up">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-lg-8">
                      ...
                      if ($inc) 
                        { 
                          $consulta = "SELECT * FROM sports WHERE tema= 2 ORDER BY fecha DESC";
                ...
                <!--
                  ...
                  <?php
                      ...
                      if ($inc) 
                        { 
                          $consulta = "SELECT * FROM comentarios_sports";
                          $resultado = mysqli_query($conection,$consulta);
                          if ($resultado) 
                            {
                              while ($row = $resultado->fetch_array()) 
                     ...
                     <div class="row">
                        ...
                        <form>
                            <div class="form-group">
                              <strong>
                              <label for="formGroupExampleInput"><?php echo $nombre;?></label> <br>
                              </strong>
                              <label for="formGroupExampleInput"><?php echo $comentario;?></label>
                           </div>
                        </form>
                        </div>
                    </div> 
